...
class Woothemes_Widget_Features extends WP_Widget
{
    ...
    public function form($instance)
    {
        ...
        <p>
            ...
            <input type="text" name="<?php echo $this->get_field_name('per_row'); ?>"
                   value="<?php echo $instance['per_row']; ?>" class="widefat"
                   id="<?php echo $this->get_field_id('per_row'); ?>"/>
        </p>
        ...
        <p>
            <input id="<?php echo $this->get_field_id('link_title'); ?>"
                   name="<?php echo $this->get_field_name('link_title'); ?>"
                   type="checkbox"<?php checked($instance['link_title'], 1); ?> />
        ...
        <p>
            <input id="<?php echo $this->get_field_id('custom_links_only'); ?>"
                   name="<?php echo $this->get_field_name('custom_links_only'); ?>"
                   type="checkbox"<?php checked($instance['custom_links_only'], 1); ?> />
...
/* Register the widget. */
add_action('widgets_init', fn() => register_widget("WooThemes_Widget_Features"), 1);

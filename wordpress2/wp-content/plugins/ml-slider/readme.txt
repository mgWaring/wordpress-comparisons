...
With MetaSlider, you can create a powerful, SEO-optimized slider, slideshow, carousel, or gallery in minutes. MetaSlider is world’s #1 responsive WordPress slider plugin. MetaSlider is the best choice for image, photo, video (YouTube and Vimeo), layer, HTML, WooCommerce product, and post feed sliders!
...
You can make your theme more engaging with MetaSlider. You can use MetaSlider’s powerful filters and actions to perfectly customize MetaSlider to your WordPress theme. MetaSlider supports any content type that your users might want, including images, photos, videos (YouTube, Vimeo, and local videos), layer slides, HTML, WooCommerce products, and more.
...
* FIXED: "Load" button in Settings and Help/Export is not functioning, #458;
...
* ADDED: New feature: Smart pad option (for Image Slides and Flex Slider only).
...
* CHANGED: "Responsive" option renamed to "R. Slides". The (old) "Responsive" option refers to the "Responsive Slides" jQuery library, but users were getting confused as the naming suggested it was the only responsive option. Flex Slider and Nivo Slider are also responsive..
...
* ADDED: SEO options (add title and alt text to slides).
...
* FIXED: qTranslate caption and URL parsing for image slides.

= [2.4.1] - 17 Oct, 13 =

* FIXED: PHP Warning (reported by and thanks to: fgirardey).
...
* CHANGED: System check added with option to dismiss messages. Checks made for: role scoper plugin, wp_footer, wordpress version and GD/ImageMagick..
